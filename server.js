...
app.get('/team_stats', function(req, res) {
 ...
 //var query2 = 'select visitor_name AS games_winner FROM football_games where visitor_score > home_score;';
 var no_of_wins = 'select count(*)  AS games_won from football_games where home_score > visitor_score;';
 var no_of_losses = 'select count(*)  AS games_lost from football_games where visitor_score > home_score;';
 db.task('get-everything', task => {
     return task.batch([
         task.any(query1),
         //task.any(query2),
 ...
 .then(query_results => {
   res.render('pages/team_stats',{
		...
		//winner:query_results[1][0].games_winner,
